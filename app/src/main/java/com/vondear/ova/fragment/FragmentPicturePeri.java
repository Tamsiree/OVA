 ...
 * Use the {@link FragmentPicturePeri#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentPicturePeri extends FragmentLazy implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static FragmentPicturePeri newInstance(String param1, String param2) {
        FragmentPicturePeri fragment = new FragmentPicturePeri();
...
//        mQuickAdapter.setAutoLoadMoreSize(3);
    ...
    private void initData(final int p) {
        GetRequest baseRequest = OkGo.get(Constants.URL_PERI_PICTURE + p);     // 请求方式和请求url
