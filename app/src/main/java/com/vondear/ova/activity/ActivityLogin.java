...
import com.vondear.ova.rong.activity.BaseActivity;
...
public class ActivityLogin extends BaseActivity {
    ...
    private void initView() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Animation animation = AnimationUtils.loadAnimation(ActivityLogin.this, R.anim.translate_anim);
    ...
    private void goToMain() {
        ...
        editor.putString(SealConst.SEALTALK_LOGING_PHONE, mEmailView.getText().toString());
        editor.putString(SealConst.SEALTALK_LOGING_PASSWORD, mPasswordView.getText().toString());
        editor.apply();
    ...
    public Object doInBackground(int requestCode, String id) throws HttpException {
        switch (requestCode) {
            case LOGIN:
                return action.login("86", mEmailView.getText().toString(), mPasswordView.getText().toString());
            case GET_TOKEN:
