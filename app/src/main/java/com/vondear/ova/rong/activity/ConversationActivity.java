package com.vondear.ova.rong.activity;
...
import com.vondear.ova.activity.ActivityMain;
...
import com.vondear.ova.rong.fragment.ConversationFragmentEx;
import com.vondear.ova.rong.server.utils.NToast;
import com.vondear.ova.rong.widget.LoadingDialog;
...
public class ConversationActivity extends BaseActivity implements View.OnClickListener {
        ...
        if (intent.getData().getScheme().equals("rong") && intent.getData().getQueryParameter("isFromPush") != null) {
            ...
            if (intent.getData().getQueryParameter("isFromPush").equals("true")) {
                ...
                if (intent.getData().getPath().contains("conversation/system")) {
                    Intent intent1 = new Intent(mContext, ActivityMain.class);
     ...
     * 以跳到 ActivityMain 为例：
     * 在 ConversationActivity 收到消息后，选择进入 ActivityMain，这样就把 ActivityMain 激活了，当你读完收到的消息点击 返回键 时，程序会退到
     * ActivityMain 页面，而不是直接退回到 桌面。
     */
    private void enterActivity() {
        ...
        if (token.equals("default")) {
            ...
            startActivity(new Intent(ConversationActivity.this, ActivityLogin.class));
            SealAppContext.getInstance().popAllActivity();
        } else {
