...
import com.vondear.ova.activity.ActivityLogin;
import com.vondear.ova.rong.activity.NewFriendListActivity;
import com.vondear.ova.rong.activity.UserDetailActivity;
import com.vondear.ova.rong.db.Friend;
import com.vondear.ova.rong.db.Groups;
import com.vondear.ova.rong.message.module.SealExtensionModule;
...
import com.vondear.ova.rong.server.response.ContactNotificationMessageData;
...
public class SealAppContext implements RongIM.ConversationListBehaviorListener,
    ...
    public void popAllActivity() {
        try {
            /*if (ActivityMain.mViewPager != null) {
                ActivityMain.mViewPager.setCurrentItem(0);
            }*/
    ...
    private void quit(boolean isKicked) {
        ...
        loginActivityIntent.setClass(mContext, ActivityLogin.class);
